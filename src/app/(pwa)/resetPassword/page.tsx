...
export default function AccountRecovery() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if(password !== repeatPassword) return onShowFeedBack(PreFeedBack.error('As senhas não conferem!'))
      const token = searchParams.get('token');    
      console.log(token);
      
      api.post(`users/changePassword/${password}`, 
        {
          token,
        }
      )
  ...
  return (
    <form 
      ...
      className="s:w-screen t:w-3/6 d:w-2/6 mx-auto flex flex-col justify-center p-4 h-screen relative"
    >
        ...
        <>
          <button className="absolute top-5 left-5">
            <ArrowBackOutlinedIcon 
              style={{ fontSize: 36, color: '#C90B0B' }} 
              ...
              <div className="py-5">
                ...
                <div className="pt-5 mt-5 flex flex-col gap-4">
                  ...
                  <InputStyled
                    ...
                    type="password"
                    placeholder="***********"
                    icon={<LockOutlined style={{ color: '#C90B0B' }} />}
                  />
                  <InputStyled
                    id="repeatPassword"
